...
class SearchBar extends Component {
  ...
  render() {
    const optionList = Object.entries(this.state.options).map(
      ([key, value]) => (
    ...
    return (
      <div className="wrapper-bar">
        ...
        <div className="pager box">
          ...
          <span>
            {" "}
            {this.props.lowBoundary} - {this.props.highBoundary}{" "}
          </span>
